      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {viewMode === "table" ? (
          ...
          {filteredMedicines.map((medicine) => (
            <div
              key={medicine._id}
              className="bg-white rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden w-full"
            >
              <div className="p-4 md:p-6">
                ...
                <p className="text-sm text-gray-600 flex flex-wrap items-center justify-between">
                  <span className="line-clamp-1 truncate w-full sm:w-auto">
                    {medicine.description}
                  </span>
                  <span className="ml-0 sm:ml-2 whitespace-nowrap">Stock: {medicine.stock}</span>
                </p>
